...
// Importing part
import { NoteCardProps } from "@/type/component";
...
import DeleteNote from "../dialog/notes/deleteNote";
import EditNote from "../dialog/notes/editNote";

// Creating and exporting NoteCard component as default
export default function NoteCard({
  ...
  return (
    <>
      <DeleteNote open={deleteOpened} onOpenChange={setDeleteOpened} id={id} />
      <EditNote
        open={editOpened}
      ...
      <ContextMenu>
        <ContextMenuTrigger asChild>
          <Link
            href={`/dashboard/notes/${id}-${title}-${createdAt}`}
            className={className}
          >
            <Card>
              <CardHeader>
