...
export default function CTA() {
  // Returning JSX
  return (
    <section className="max-w-4xl border-x border-foreground/10 mx-auto lg:h-dvh h-[300px] lg:flex items-center justify-center">
      <main className="prose dark:prose-invert prose-neutral p-4 max-w-full">
        <h2 className="mt-0 lg:text-center">
